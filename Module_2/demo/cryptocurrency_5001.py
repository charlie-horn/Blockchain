...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, reciever = 'Charlie', amount = 1)
...
def connect_node():
    ...
    response = {'message': 'All nodes are connected. The Blockchain now contains the following nodes:',
